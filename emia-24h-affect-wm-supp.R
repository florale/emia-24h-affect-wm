...
emia_24h_sen_sub_30_list <- lapply(list(
  m_valence_sen_sub, m_energeticarousal_sen_sub, m_calmness_sen_sub, m_wm_sen_sub
), function(X) {
...
emia_24h_sen_sub_5_list <- lapply(list(
  m_valence_sen_sub, m_energeticarousal_sen_sub, m_calmness_sen_sub, m_wm_sen_sub
), function(X) {
...
emia_24h_sen_sub_60_list <- lapply(list(
  m_valence_sen_sub, m_energeticarousal_sen_sub, m_calmness_sen_sub, m_wm_sen_sub
), function(X) {
...
# graphs
emia_24h_sen_plot_b_supp <- readRDS(paste0(outputdir, "emia_24h_sen_plot_b_supp", ".RDS"))
emia_24h_sen_plot_w_supp <- readRDS(paste0(outputdir, "emia_24h_sen_plot_w_supp", ".RDS"))
