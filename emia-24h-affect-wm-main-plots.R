...
sub_models   <- c("m_valence_sub", "m_energeticarousal_sub", "m_calmness_sub", "m_wm_sub")
...
emia_24h_plot_b <- foreach(i = 1:20,
...
emia_24h_plot_w <- foreach(i = 21:40,
                             .packages = "multilevelcoda") %dopar% {
...
# between
grDevices::cairo_pdf(
  file = paste0(outputdir, "emia_24h_between", ".pdf"),
  width = 10,
  height = 12,
)
...
emia_24h_plot_b_supp <- foreach(i = 1:20,
                                  .packages = "multilevelcoda") %dopar% {
