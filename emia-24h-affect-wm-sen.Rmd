---
title: "Supplementary materials: Sensitivity analysis for Associations between daily composition of 24-hour physical behavior with affective states and working memory"
...
```
# Sensitivity results using at least 3 ratings of affect per day
## 60-minute reallocations
 * Reallocation of 60 minutes between movement behaviours and *valence*
 
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_60_list[[1]], align = "l", espacce = F) %>%
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_60_list[[2]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_60_list[[3]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_60_list[[4]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_30_list[[1]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#E9E6F1")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_30_list[[2]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#CBD5D0")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_30_list[[3]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#FAF4E8")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_30_list[[4]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#F5E1D5")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_5_list[[1]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#E9E6F1")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_5_list[[2]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#CBD5D0")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_5_list[[3]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#FAF4E8")
```
...
```{r, warning=FALSE, echo=FALSE}
kbl(emia_24h_sen_sub_5_list[[4]], align = "l", espacce = F) %>%
  kable_styling(bootstrap_options = c("hover", "condensed"), fixed_thead = T) %>%
  row_spec(0, background = "#F5E1D5")
```
...
walk(emia_24h_sen_plot_b_supp, print)
```

### Within person level

```{r, warning=FALSE, echo = FALSE, results='asis', fig.align='center'}
walk(emia_24h_sen_plot_w_supp, print)
```